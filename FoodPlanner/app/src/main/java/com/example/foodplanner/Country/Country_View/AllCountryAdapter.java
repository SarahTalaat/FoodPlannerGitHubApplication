...
import com.example.foodplanner.Country.Country_View.AllCountryAdapter;
import com.example.foodplanner.Country.Country_View.OnCountryClickListener;
...
import java.util.ArrayList;
    ...
    public class AllCountryAdapter extends RecyclerView.Adapter<com.example.foodplanner.Country.Country_View.AllCountryAdapter.MyViewHolder>  {
        ...
        @NonNull
        @Override
        public com.example.foodplanner.Country.Country_View.AllCountryAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            LayoutInflater inflater = (LayoutInflater) context.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
            View view = inflater.inflate(R.layout.fragment_country_card_view,parent,false);
            com.example.foodplanner.Country.Country_View.AllCountryAdapter.MyViewHolder myViewHolder = new com.example.foodplanner.Country.Country_View.AllCountryAdapter.MyViewHolder(view);
        ...
        public void onBindViewHolder(@NonNull com.example.foodplanner.Country.Country_View.AllCountryAdapter.MyViewHolder holder , int position) {
